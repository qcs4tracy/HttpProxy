...
#ifndef __HttpProxy__socket__
#define __HttpProxy__socket__
...
public:
     ...
     */
    void send(const void *buffer, size_t bufferLen) throw(SocketException);
     ...
     */
    ssize_t recv(void *buffer, int bufferLen) throw(SocketException);
...
#endif /* defined(__HttpProxy__socket__) */
